...
public class RedirectController {
    ...
    public String uriTemplate(RedirectAttributes redirectAttrs) {
        ...
        redirectAttrs.addAttribute("date", new Date());  // Appended as a query parameter
    ...
    public String uriComponentsBuilder() {
        String date = this.conversionService.convert(new Date(), String.class);
    ...
    public String show(@PathVariable String account, @RequestParam(required=false) Date date) {
